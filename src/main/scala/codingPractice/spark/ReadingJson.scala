...
object ReadingJson {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val jsonDf = spark
      ...
      .json("src/main/scala/codingPractice/test.json")
    ...
    val parseOrdersDf1 = parseOrdersDf.withColumn("customerId", $"orders".getItem("customerId"))
